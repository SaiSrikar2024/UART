...
The design implements UART transmission and reception using separate FSM-based TX and RX modules connected in a loopback configuration. Data transmitted serially is received back correctly and verified through simulation as well as FPGA hardware testing.
...
- Synthesised and implemented using Xilinx Vivado
